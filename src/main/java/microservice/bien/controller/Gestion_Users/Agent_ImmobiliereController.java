...
public class Agent_ImmobiliereController {
    ...
    public Agent_Immobiliere update(@RequestBody Agent_Immobiliere agent_immobiliereObj) {
    	agent_immobiliereService.save(agent_immobiliereObj);
    	return agent_immobiliereObj;
 }
